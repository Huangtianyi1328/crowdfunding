package com.huangtianyi.crowd.entity.po;
...
public class ProjectPO {
    ...
    private String projectName;//po

    private String projectDescription;//po

    private Long money;//po

    private Integer day;//po
    ...
    private String createdate;//po

    private Integer follower;

    private String headerPicturePath;//po
